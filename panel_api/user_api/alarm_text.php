...
if ($connect) {
    ...
    if ($userValidator->isValidUser()) {
        ...
        $array = [];
        $larmQuery = "SELECT PanelAlarm.id,PanelAlarm.restaurant_id,PanelAlarm.message, PanelAlarm.is_valid, PanelAlarm.date_time  FROM PanelAlarm WHERE PanelAlarm.is_valid='1' AND restaurant_id = '$restaurantID'";
